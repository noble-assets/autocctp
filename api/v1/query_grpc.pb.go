...
const (
	Query_Address_FullMethodName                  = "/noble.autocctp.v1.Query/Address"
	Query_Stats_FullMethodName                    = "/noble.autocctp.v1.Query/Stats"
	Query_StatsByDestinationDomain_FullMethodName = "/noble.autocctp.v1.Query/StatsByDestinationDomain"
)
...
func (c *queryClient) StatsByDestinationDomain(ctx context.Context, in *QueryStatsByDestinationDomain, opts ...grpc.CallOption) (*QueryStatsByDestinationDomainResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_StatsByDestinationDomain_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) StatsByDestinationDomain(context.Context, *QueryStatsByDestinationDomain) (*QueryStatsByDestinationDomainResponse, error) {
...
func _Query_StatsByDestinationDomain_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_StatsByDestinationDomain_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
