...
var (
	...
	fd_Account_destination_domain protoreflect.FieldDescriptor
	fd_Account_mint_recipient     protoreflect.FieldDescriptor
	fd_Account_fallback_recipient protoreflect.FieldDescriptor
	fd_Account_destination_caller protoreflect.FieldDescriptor
)

func init() {
	file_noble_autocctp_v1_account_proto_init()
	md_Account = File_noble_autocctp_v1_account_proto.Messages().ByName("Account")
	fd_Account_base_account = md_Account.Fields().ByName("base_account")
	fd_Account_destination_domain = md_Account.Fields().ByName("destination_domain")
	fd_Account_mint_recipient = md_Account.Fields().ByName("mint_recipient")
	fd_Account_fallback_recipient = md_Account.Fields().ByName("fallback_recipient")
	fd_Account_destination_caller = md_Account.Fields().ByName("destination_caller")
}
...
func (x *Account) slowProtoReflect() protoreflect.Message {
	mi := &file_noble_autocctp_v1_account_proto_msgTypes[0]
...
func (x *fastReflection_Account) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "noble.autocctp.v1.Account.base_account":
		return x.BaseAccount != nil
	case "noble.autocctp.v1.Account.destination_domain":
		return x.DestinationDomain != uint32(0)
	case "noble.autocctp.v1.Account.mint_recipient":
		return len(x.MintRecipient) != 0
	case "noble.autocctp.v1.Account.fallback_recipient":
		return x.FallbackRecipient != ""
	case "noble.autocctp.v1.Account.destination_caller":
		return len(x.DestinationCaller) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: noble.autocctp.v1.Account"))
		}
		panic(fmt.Errorf("message noble.autocctp.v1.Account does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Account) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message noble.autocctp.v1.Account does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Account) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "noble.autocctp.v1.Account.destination_domain":
		panic(fmt.Errorf("field destination_domain of message noble.autocctp.v1.Account is not mutable"))
	case "noble.autocctp.v1.Account.mint_recipient":
		panic(fmt.Errorf("field mint_recipient of message noble.autocctp.v1.Account is not mutable"))
	case "noble.autocctp.v1.Account.fallback_recipient":
		panic(fmt.Errorf("field fallback_recipient of message noble.autocctp.v1.Account is not mutable"))
	case "noble.autocctp.v1.Account.destination_caller":
		panic(fmt.Errorf("field destination_caller of message noble.autocctp.v1.Account is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: noble.autocctp.v1.Account"))
		}
...
func (x *fastReflection_Account) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in noble.autocctp.v1.Account", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_noble_autocctp_v1_account_proto_init()
	md_PubKey = File_noble_autocctp_v1_account_proto.Messages().ByName("PubKey")
...
func (x *PubKey) slowProtoReflect() protoreflect.Message {
	mi := &file_noble_autocctp_v1_account_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_PubKey) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "noble.autocctp.v1.PubKey.key":
		return len(x.Key) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: noble.autocctp.v1.PubKey"))
		}
		panic(fmt.Errorf("message noble.autocctp.v1.PubKey does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_PubKey) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message noble.autocctp.v1.PubKey does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_PubKey) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "noble.autocctp.v1.PubKey.key":
		panic(fmt.Errorf("field key of message noble.autocctp.v1.PubKey is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: noble.autocctp.v1.PubKey"))
		}
...
func (x *fastReflection_PubKey) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in noble.autocctp.v1.PubKey", d.FullName()))
	}
	panic("unreachable")
}
...
func (*Account) Descriptor() ([]byte, []int) {
	return file_noble_autocctp_v1_account_proto_rawDescGZIP(), []int{0}
}
...
func (x *Account) GetDestinationDomain() uint32 {
	if x != nil {
...
func (x *Account) GetMintRecipient() []byte {
	if x != nil {
...
func (x *Account) GetFallbackRecipient() string {
	if x != nil {
		return x.FallbackRecipient
	}
	return ""
...
func (x *Account) GetDestinationCaller() []byte {
	if x != nil {
...
func (*PubKey) Descriptor() ([]byte, []int) {
	return file_noble_autocctp_v1_account_proto_rawDescGZIP(), []int{1}
}
...
var File_noble_autocctp_v1_account_proto protoreflect.FileDescriptor

var file_noble_autocctp_v1_account_proto_rawDesc = []byte{
	...
	0x70, 0x2e, 0x76, 0x31, 0x1a, 0x1e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2f, 0x61, 0x75, 0x74,
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xaa, 0x02, 0x0a, 0x07, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	...
	,
	...
	,
}

var (
	file_noble_autocctp_v1_account_proto_rawDescOnce sync.Once
	file_noble_autocctp_v1_account_proto_rawDescData = file_noble_autocctp_v1_account_proto_rawDesc
)

func file_noble_autocctp_v1_account_proto_rawDescGZIP() []byte {
	file_noble_autocctp_v1_account_proto_rawDescOnce.Do(func() {
		file_noble_autocctp_v1_account_proto_rawDescData = protoimpl.X.CompressGZIP(file_noble_autocctp_v1_account_proto_rawDescData)
	})
	return file_noble_autocctp_v1_account_proto_rawDescData
}

var file_noble_autocctp_v1_account_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_noble_autocctp_v1_account_proto_goTypes = []interface{}{
	(*Account)(nil),             // 0: noble.autocctp.v1.Account
	(*PubKey)(nil),              // 1: noble.autocctp.v1.PubKey
	(*v1beta1.BaseAccount)(nil), // 2: cosmos.auth.v1beta1.BaseAccount
}
var file_noble_autocctp_v1_account_proto_depIdxs = []int32{
	2, // 0: noble.autocctp.v1.Account.base_account:type_name -> cosmos.auth.v1beta1.BaseAccount
...
func init() { file_noble_autocctp_v1_account_proto_init() }
func file_noble_autocctp_v1_account_proto_init() {
	if File_noble_autocctp_v1_account_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_noble_autocctp_v1_account_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_noble_autocctp_v1_account_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PubKey); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_noble_autocctp_v1_account_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_noble_autocctp_v1_account_proto_goTypes,
		DependencyIndexes: file_noble_autocctp_v1_account_proto_depIdxs,
		MessageInfos:      file_noble_autocctp_v1_account_proto_msgTypes,
	}.Build()
	File_noble_autocctp_v1_account_proto = out.File
	file_noble_autocctp_v1_account_proto_rawDesc = nil
	file_noble_autocctp_v1_account_proto_goTypes = nil
	file_noble_autocctp_v1_account_proto_depIdxs = nil
}
